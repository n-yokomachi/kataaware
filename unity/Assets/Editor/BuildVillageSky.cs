...
namespace HalfAware.EditorTools
{
    ...
    public static partial class BuildVillage
    {
        ...
        /// <summary>
        /// 夕方の日の向き（Euler）。8 月中旬の 19:45 ほど、日は西北西（方位 290 度）の仰角 11 度。
        /// **庭に日を入れる**（2026-09-27）。仰角 5 度では、西の板の塀（1.8 m）と西の花の縁の影が 20 m 伸びて庭ぜんたいを覆い、
        /// 夕陽の庭（場面 6）が暗い影の中に沈んだ。11 度なら塀の影は芝の西の半分で止まり、
        /// 芝の東の半分と東の花の縁と温室に斜めの金色の日が当たり、タチアオイの長い影が芝を横切る
        /// </summary>
        static readonly Vector3 EveningAim = new Vector3(11f, 290f - 180f, 0f);
