...
namespace HalfAware.EditorTools
{
    ...
    public static class WriteDiveRoster
    {
        ...
        public static List<DiveEntry> Entries()
        {
            ...
            // 9. 公園の門。隣を歩いていた孫息子が鳩を追って駆け出し、呼び戻して餌の袋を持たせる
            ...
            // 10. 同じ公園。鳩を追って池の縁まで来ていて祖母に呼ばれ、戻って餌の袋を渡される
        ...
        static readonly string[][] Talks =
        {
            ...
            new[]
            {
                ...
                "ローザ「はいはい」",  //  5 秒
                "ローザ「ルーカス！　戻りなさい」",  // 11 秒
                "ルーカス「今行くって。鳩がすごいんだよ」",  // 17 秒
                "ローザ「じゃあ、これ撒いてあげて」",  // 23 秒
            },
            // 11. ルーカス
            new[]
            {
                "ローザ「ルーカス、戻りなさい」",  //  0 秒
                "ルーカス「今行くって。鳩がすごいんだよ」",  //  5 秒
                "ローザ「じゃあ、これ撒いてあげて」",  // 12 秒
                "ルーカス「うわ、全部こっち来た」",  // 19 秒
            },
            // 12. プリヤ
            new[]
            {
