...
namespace HalfAware.EditorTools
{
    ...
    public static class WriteAlleyScript
    {
        ...
        public static readonly string[][] StreetPages =
        {
            ...
            new[]
            {
                "1世紀前まではモダニズムからポストモダニズムへの過渡期にあった建築物が大窓を並べ、落ち着いた都会の一角をなしていたというこの通りも、今ではそのほとんどに、瞼の裏に焼き付くような極彩色のネオンが熱帯植物のように絡みついている",
            },
            new[]
            {
            ...
            new[]
            {
                "近年の技術革命は一部の民衆に対して、数世紀前の小説や映画のジャンルであった『サイバーパンク』を想起させた",
                "かの舞台を彩る、日本の電脳都市｜千葉市《チバ・シティ》や宇宙船の浮かぶ｜羅府《ロサンゼルス》に憧れた人々は、かつて実在したこともない懐かしい街並みを取り戻そうとするかのように、通りを雑多に飾り立て、ネオン管を張り巡らせたのだ",
            },
            new[]
            {
                "レトロ・サイバーパンクのムーブメント、その結果がこのけばけばしいストリートだ。大昔の産業革命が吐き出した霧の代わりに、今この都市を覆っているのは、クラッカーたちが撒き散らすナーヴ・クラック用のナノマシンの黒雲だ",
        ...
        {
            "「グレビル・ストリート」と書かれている",
            "「ホルボーン・ケミスト　インプラント用品と修理　夜通し営業」と書かれている",
            "「ナーヴ・ターミナル　適合と調整　予約不要」と書かれている",
            "「H・グッドチャイルド・アンド・サン　質屋　創業1871年」と書かれている",
            "「ナノマシン注意報　端末にファイアウォールを」と書かれている",
        };
