...
namespace HalfAware.EditorTools
{
    ...
    public static class WriteAlleyScript
    {
        ...
        public static readonly string[][] StreetPages =
        {
            new[]
            {
                "ホルボーンの大通りからグレビル・ストリートに入ったころから、この倫敦の霧がかった夜空からは雨が降り出した。グレビル・ストリートこのあたりでも特にネオンサインが眩い",
            },
            new[]
            {
            ...
            new[]
            {
                ...
                "人間が本来具有する目や耳といった感覚器官や、一部の運動機能の生活上の必要性を大幅に下げたインプラント型神経端末、「ナーヴ・ターミナル」は最小の生活基盤（Minimum Infrastructure）とも呼ばれる普及率となった",
            },
            new[]
            {
                "こうした技術革命は一部の民衆に対して、数世紀前の小説や映画のジャンルであった『サイバーパンク』を想起させた",
                "かの舞台を彩る、日本の電脳都市千葉市（チバ・シティ）や宇宙船の浮かぶ羅府（ロサンゼルス）に憧れた人々は、かつて実在したこともない懐かしい街並みを取り戻そうとするかのように、通りを雑多に飾り立て、ネオン管を張り巡らせたのだ",
            },
            new[]
            {
