...
Shader "HalfAware/Screenwater"
{
    Properties
    {
        [HDR] _BaseColor ("水の色。線形。**夜の空より暗く取る。** 水は自分で光らない", Color) = (0.104, 0.106, 0.112, 1)
        [HDR] _Glint ("筋の頭の色。灯りを集めるところ。空（0.115）をわずかに上回る程度に留める", Color) = (0.126, 0.128, 0.136, 1)
        _Veil ("薄膜の濃さ", Range(0, 1)) = 0.13
        _Sand ("砂目の濃さ", Range(0, 1)) = 0.32
        _Rill ("筋の濃さ", Range(0, 1)) = 0.85
        _Spray ("ちぎれて飛ぶ水の濃さ", Range(0, 1)) = 0.34
        _Smear ("後ろの灯りをにじませる量。掛け算で効く。**雨が見えるのは主にここ**", Range(0, 3)) = 0.62
