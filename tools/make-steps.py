...
**一度「軽い」と差し戻された。** はじめは 360Hz から下を丸ごと落として打音を 2.6 倍にしていて、
確かに硬い面の音にはなったが、体重の乗っていない音になった。踏むのは大人一人で、
靴底の打ちつけと同時に床へ重さが掛かる。落とす端を下げ、素のまま残す量を倍に増やし、
打音の持ち上げを減らして、重心を下げてある
...
SLAP_GAIN = 1.9
# 素のまま残す量。倍。0 にすると打音だけの薄い音になる。重さはここが持つ
BODY_GAIN = 0.62
# 尾の減衰の時定数。秒
TAIL = 0.062
